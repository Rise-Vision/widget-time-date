# Time and Date Widget [![Circle CI](https://circleci.com/gh/Rise-Vision/widget-time-date.svg?style=svg)](https://circleci.com/gh/Rise-Vision/widget-time-date)

## Introduction

The Time and Date Widget allows you to show the current time and date according to the time and date configured on the operating system it is used on.

Time and Date Widget works in conjunction with [Rise Vision](http://www.risevision.com), the [digital signage management application](http://rva.risevision.com/) that runs on [Google Cloud](https://cloud.google.com).
...
```
git clone https://github.com/Rise-Vision/widget-time-date.git
```
