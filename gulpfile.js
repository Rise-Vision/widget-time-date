...
(function () {
    ...
    gulp.task("source-dev", ["lint"], function () {
        return gulp.src(["./src/*.html"])
            .pipe(usemin({outSourceMap: false}))
            .pipe(gulp.dest("dist/"));
    });
    ...
    gulp.task("images", ["color-picker-images"], function () {
        return gulp.src(imgFiles)
            .pipe(gulp.dest("dist/img"));
    });

    gulp.task("color-picker-images", function () {
        return gulp.src("src/components/mjolnic-bootstrap-colorpicker/dist/img/**/*")
            .pipe(gulp.dest("dist/img"));
    });
